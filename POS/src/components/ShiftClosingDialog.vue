...
// Ctrl/Cmd+S closes the shift. Enter is left to the amount inputs.
// Only in entry mode (not the post-close success report).
useDialogSubmit({
	isOpen: open,
	onSubmit: () => submitClosing(),
	canSubmit: () =>
		!showSuccessReport.value && canSubmit.value && !submitResource.loading,
	enter: false,
})
