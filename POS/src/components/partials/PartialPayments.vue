	...
	<Transition name="fade">
		...
		>
			...
			<div class="fixed inset-0 flex items-center justify-center p-4 md:p-6">
				<div
					class="w-full max-w-6xl max-h-[90vh] bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col"
				>
					<!-- Header -->
					<div
						class="flex items-center justify-between px-6 py-5 border-b bg-gradient-to-r from-orange-50 to-amber-50"
					>
						...
						<div class="flex items-center gap-2">
							...
							<div
								...
								class="px-4 py-2 bg-orange-100 rounded-lg border border-orange-200"
							>
					...
					<div class="flex-1 overflow-y-auto bg-gray-50">
						...
						>
							<div
								class="animate-spin rounded-full h-12 w-12 border-b-3 border-orange-500 mb-4"
							></div>
						...
						>
							...
							<p class="text-gray-600 font-medium">
								{{ __("No Partial Payments") }}
							</p>
							<p class="text-gray-500 text-sm mt-1">
								{{ __("All invoices are either fully paid or unpaid") }}
							</p>
						</div>
